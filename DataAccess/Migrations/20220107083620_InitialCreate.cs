        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CustomerEmail = table.Column<string>(type: "nvarchar(80)", maxLength: 80, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SubHeader = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CommentToProducts", x => x.ID);
                    table.ForeignKey(
                        name: "FK_CommentToProducts_Comments_CommentID",
                        column: x => x.CommentID,
                        principalTable: "Comments",
                        principalColumn: "ID",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CommentToProducts_Products_ProductID",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CommentToProducts_CommentID",
                table: "CommentToProducts",
                column: "CommentID");

            migrationBuilder.CreateIndex(
                name: "IX_CommentToProducts_ProductID",
                table: "CommentToProducts",
                column: "ProductID");
